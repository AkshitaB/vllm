...
"""Inference-only FlexMoE model compatible with HuggingFace weights.

Implements the FlexOlmoNoQKNormPrenormShared architecture:
  - Pre-norm transformer with RMSNorm
  - No Q/K normalization in attention
  - MoE with routed experts (FusedMoE) + a shared expert MLP
  - Shared expert output combined as:
